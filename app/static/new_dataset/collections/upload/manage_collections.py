...
def addAllImagesFromFolder():
    if (this_collection_id==fashion_blogger_id):
        ...
        json_data = codecs.open("full_bodyYoox.json", "r", encoding='utf-8', errors='ignore')
        names_obj={}
